    ...
    async updateDaily(fromDate) {
        try {
            ...
            if (startDate.getTime() <= today.getTime()) {
                ...
                console.log('取得対象の日付一覧:', dates.map(d => format(d, 'yyyy-MM-dd')));
            ...
            if (this.isQuarterEnd(today)) {
                await this.storage.finalizeQuarter(this.getCurrentQuarter(today), format(today, 'yyyy'));
            }
        }
        catch (error) {
