...
export const FAQ_DATA: FAQItem[] = [
    ...
    },
    {
        ...
        answer: 'はい、**配当金明細の計算機能**は無料でお試しいただけます！\n\nトップページの「無料で試す（配当金）」ボタンからアクセスできます。\n\n無料版では計算結果の確認が可能ですが、CSVエクスポート機能を使うにはライセンスが必要です。',
    ...
    },
    {
        ...
        answer: '為替レートは**毎週土曜日 09:00（日本時間）**に自動更新されます。\n\n平日5日分の確定した為替レートを週末にまとめて取得する仕組みです。\n\n最新レートが必要な場合は、土曜日以降にデータを再計算してください。',
    ...
    },
    {
        ...
        answer: '購入完了後、**Gumroadから送られるメール**にライセンスキーが記載されています。\n\nメールが届かない場合は、Gumroadの購入履歴からも確認できます。\n\n迷惑メールフォルダも確認してください。',
    ...
    },
    {
        ...
        answer: 'CSVをアップロード後、画面下部に**月ごとの集計**と**年間サマリー**が自動表示されます。\n\n配当金、利子、源泉徴収額がそれぞれ月ごとにまとめられています。',
        keywords: ['月次', 'サマリー', '集計', '合計', '月ごと']
    },
    {
        id: 'feature-gainloss-1',
        category: '売却損益',
        question: '短期・長期の違いは何ですか？',
        answer: '日本の税制では、保有期間によって区分されます：\n\n**短期譲渡**: 保有期間1年未満の売却\n**長期譲渡**: 保有期間1年以上の売却\n\n確定申告時に区分して記載する必要があります。このツールでは自動で分類されます。',
        keywords: ['短期', '長期', '譲渡', '違い', '区分', '保有期間']
    },
    {
        id: 'feature-simulator-1',
        category: 'シミュレーター',
        question: 'シミュレーターの使い方を教えてください',
        answer: 'シミュレーターでは、Firstradeの画面から**損益データをコピー＆ペースト**するだけで計算できます。\n\n**使い方**:\n1. Firstradeで保有銘柄の損益を表示\n2. データをコピー\n3. シミュレーターの入力欄にペースト\n4. 「計算」ボタンをクリック\n\nCSVファイル不要で、概算の確定申告額を確認できます。',
